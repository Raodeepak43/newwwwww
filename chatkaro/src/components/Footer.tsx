      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-sm mb-2">
              अपने WhatsApp को AI की ताकत से जोड़ें और अपने बिज़नेस को ऑटोमेट
              करें।
            </p>
            <p className="text-gray-600 text-sm leading-relaxed max-w-sm">
              Connect your WhatsApp with AI power and automate your business
              effortlessly.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center">
          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} ChatKaro. सभी अधिकार सुरक्षित —
            All rights reserved.
          </p>
        </div>
      </div>
