...
const features = [
  {
    ...
    descHi: "AI आपके कस्टमर्स को तुरंत जवाब देता है — दिन हो या रात।",
    descEn:
  ...
  },
  {
    ...
    descHi: "हर मैसेज, रिस्पॉन्स टाइम और कस्टमर डेटा को ट्रैक करें।",
    descEn:
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <AnimateOnScroll key={i} animation="fade-up" delay={i * 0.15}>
              <div className="group relative p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-green-500/30 transition-all duration-300 hover:bg-white/[0.05] h-full">
